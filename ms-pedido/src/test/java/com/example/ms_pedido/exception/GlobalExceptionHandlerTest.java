...
class GlobalExceptionHandlerTest {
    ...
    void manejarRuntimeException_conMensajeNoEncontrado_retorna404() {
        RuntimeException ex = new RuntimeException("Pedido no encontrado con id: 99");
    ...
    void manejarValidacion_retorna400ConErrores() throws Exception {
        ...
        FieldError error2 = new FieldError("requestDTO", "cantidad", "La cantidad es obligatoria");
        ...
        assertEquals("La cantidad es obligatoria", errores.get("cantidad"));
    }

    @SuppressWarnings("unchecked")
    @Test
    void manejarValidacion_unSoloError_retorna400() throws Exception {
        MethodParameter parameter = mock(MethodParameter.class);
        BindingResult bindingResult = mock(BindingResult.class);

        FieldError error = new FieldError("requestDTO", "productoId", "El productoId es obligatorio");
    ...
    @Test
    void manejarRuntimeException_productoNoExiste_retorna404() {
