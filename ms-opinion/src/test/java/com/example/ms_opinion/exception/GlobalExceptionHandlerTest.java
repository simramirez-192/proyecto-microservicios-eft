package com.example.ms_opinion.exception;
...
class GlobalExceptionHandlerTest {
    ...
    void testManejarRuntimeException_conMensajeNoExiste_retorna404() {
        RuntimeException ex = new RuntimeException("El cliente con id 5 no existe en ms-cliente");
    ...
    @Test
    void testManejarRuntimeException_conMensajeProductoNoExiste_retorna404() {
    ...
    @Test
    void testManejarRuntimeException_mensajeEncontrada_retorna400() {
        RuntimeException ex = new RuntimeException("Opinion no encontrada con id: 99");
    ...
    void testManejarValidacion_retorna400ConErrores() throws Exception {
        ...
        FieldError error2 = new FieldError("requestDTO", "puntuacion", "La puntuacion es obligatoria");
        ...
        assertEquals("La puntuacion es obligatoria", errores.get("puntuacion"));
    }
    ...
    @Test
    void testManejarRuntimeException_caseInsensitiveNoExiste() {
        RuntimeException ex = new RuntimeException("EL CLIENTE CON ID 5 NO EXISTE");
    ...
    void testManejarValidacion_unSoloError_retorna400() throws Exception {
        ...
        FieldError error = new FieldError("requestDTO", "comentario", "El comentario es obligatorio");
        ...
        assertEquals("El comentario es obligatorio", errores.get("comentario"));
    }
}
