...
class GlobalExceptionHandlerTest {
    ...
    void testManejarRuntimeException_conMensajeNoEncontrado_retorna404() {
        RuntimeException ex = new RuntimeException("Pago no encontrado con id: 99");
    ...
    void testManejarRuntimeException_conMensajeNoExiste_retorna404() {
        RuntimeException ex = new RuntimeException("El pedido con id 10 no existe en ms-pedido");
    ...
    void testManejarValidacion_retorna400ConErrores() throws Exception {
        ...
        FieldError error1 = new FieldError("requestDTO", "pedidoId", "El pedidoId es obligatorio");
        FieldError error2 = new FieldError("requestDTO", "metodoPago", "El metodo de pago es obligatorio");
        ...
        assertEquals("El pedidoId es obligatorio", errores.get("pedidoId"));
        assertEquals("El metodo de pago es obligatorio", errores.get("metodoPago"));
    }

    @SuppressWarnings("unchecked")
    @Test
    void testManejarValidacion_unSoloCampo_retorna400ConUnError() throws Exception {
        MethodParameter parameter = mock(MethodParameter.class);
        BindingResult bindingResult = mock(BindingResult.class);

        FieldError error = new FieldError("requestDTO", "metodoPago", "El metodo de pago es obligatorio");
    ...
    void testManejarRuntimeException_mensajeMinusculasNoEncontrado_retorna404() {
        RuntimeException ex = new RuntimeException("Pago NO ENCONTRADO con id: 5");
    ...
    void testManejarRuntimeException_mensajeMinusculasNoExiste_retorna404() {
        RuntimeException ex = new RuntimeException("El pedido NO EXISTE en ms-pedido");
