...
class GlobalExceptionHandlerTest {
    ...
    void testManejarRuntimeException_conMensajeNoEncontrado_retorna404() {
        RuntimeException ex = new RuntimeException("Envio no encontrado con id: 99");
    ...
    void testManejarValidacion_retorna400ConErrores() throws Exception {
        ...
        FieldError error2 = new FieldError("requestDTO", "direccion", "La direccion es obligatoria");
        ...
        assertEquals("La direccion es obligatoria", errores.get("direccion"));
    }
